...
export const useDrawerAnimation = (isPersistent, onClose) => {
  console.log('useDrawerAnimation called:', { isPersistent, screenWidth });
  ...
  const openDrawer = () => {
    console.log('openDrawer called, setting translateX to 0');
    translateX.value = withTiming(0, { duration: 300 });
  };

  const closeDrawer = () => {
    const closePosition = -screenWidth * 0.8;
    console.log('closeDrawer called, setting translateX to', closePosition);
